            ...
            <form role="form" method="POST" action="{{ route('register') }}">
              ...
              <div class="form-group">
                <div class="input-group input-group-alternative mb-3">
                  ...
                  <!-- Video -->
                  <!-- <input class="form-control" placeholder="Email" type="email" id="email" name="email" value="{{ old('email') }}" required> -->
              ...
              <div class="form-group">
                <div class="input-group input-group-alternative">
                  ...
                  <!-- Test first -->
                  <input class="form-control" placeholder="Confirmar contraseña" type="password" id="password-confirm" name="password_confirmation" required autocomplete="new-password">
                  <!-- Video -->
                  <!-- <input class="form-control" placeholder="Confirmar contraseña" type="password" id="password-confirm" name="password_confirmation" required> -->
